...
/*
 Generated class for the AddReseller page.

 See http://ionicframework.com/docs/v2/components/#navigation for more info on
 Ionic pages and navigation.
 */
@Component({
  selector: 'page-add-reseller',
  templateUrl: 'add-reseller.html'
})
export class AddResellerPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad AddResellerPage');
  }
  ...
  addNewRepairService() {
    ...
    this.navParams.data.tenant.configuration.reseller.push(repairService)
